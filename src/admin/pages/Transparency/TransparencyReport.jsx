            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <div className="flex gap-2 sm:gap-3 pt-3 sm:pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-green-400 disabled:cursor-not-allowed flex items-center justify-center gap-1.5 sm:gap-2"
                >
                  {submitting ? (
                    <>
