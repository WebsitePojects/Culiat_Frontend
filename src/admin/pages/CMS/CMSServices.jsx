...
const CMSServices = () => {
  ...
  const iconOptions = [
    'FileText', 'Home', 'BadgeCheck', 'Building2', 'HandCoins', 
    'Hammer', 'AlertCircle', 'HeartHandshake', 'Shield', 'Heart'
  ];
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">CMS - Services</h1>
          <p className="text-gray-600 mt-1">Manage homepage services section</p>
        </div>
        <button
          onClick={() => {
            resetForm();
              ...
              <tr key={service._id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-900">{service.displayOrder}</span>
                  </div>
                </td>
